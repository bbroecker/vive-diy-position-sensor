...
BluetoothCommunication::BluetoothCommunication(uint32_t id)
    : com_id_{id} {
}



void BluetoothCommunication::consume(const ObjectPosition& obj_pos) {

}



void BluetoothCommunication::start() {
  BLEsetup();
}


void BluetoothCommunication::do_work(Timestamp cur_time) {
